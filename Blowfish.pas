...
type
  ...
  Public
    ...
    Procedure Decrypt(var Block : TBFBlock); overload;
    Procedure Decrypt(var Data); overload;
  end;
...
Constructor TBlowFish.Create(const Key; KeySize : Integer);
...
procedure TBlowFish.Decrypt(var Data);
var
  I : Integer;
  xl,xr,temp : Cardinal;
  block: ^TBFBlock;
